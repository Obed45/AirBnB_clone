#!/usr/bin/python3
"""Unittest for base_model.py Classes"""
...
class TestBaseModel_instantiation(unittest.Testcase):
    ...
    def test_str_representations(self):
        ...
        bmstr = bm.__str__()
        self.assertIn("[BaseModel] (123546)", bmstr)
...
class TestBaseModel_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        bm = BaseModel()
        bm.name = "Holberton" # Verify this line
        bm.my_number = 98 # Verify this line
    ...
    def test_to_dict_output(self):
        ...
        bm = BaseModel()
        bm.id = "123456"
        bm.created_at = am.updated_at = dt
        tdict = {
                'id': '123456',
                '__class__': 'BaseModel',
