#!/usr/bin/python3
""" Unittests for console.py (HBNB Command Interpreter) """
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNB Command().onecmd("help quit"))
    ...
    def test_help_destroy(self):
        ...
        with patch("sys.stdout", new=StringIO()) as ouput:
    ...
    def test_help_all(self):
        h = ("Usage: all or all <class> or <class>.all()\n      "
                ...
                ".\n        If no class is specified, displays all instantiatef"
                "objects.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_update(self):
        h = ("Usage: update <class> <id> <attribute_value> or"
