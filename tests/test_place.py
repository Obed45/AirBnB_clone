...
class TestPlace_instantiation(unittest.Testcase):
    ...
    def test_number_rooms_is_public_class_attribute(self):
        pl = Place()
        self.assertEqual(int, type(Place.name))
        self.assertIn("number_rooms", dir(pl))
        self.assertNotIn("number_rooms", pl.__dict__)

    def test_number_bathrooms_is_public_class_attributr(self):
        pl = Place()
        self.assertEqual(int, type(Place.number_rooms))
        self.assertIn("number_rooms", dir(pl))
        self.assertNoteIn("number_rooms", pl.__dict__)
    ...
    def test_str_representations(self):
        ...
        plstr = pl.__str__()
        self.assertIn("[Place] (123546)", plstr)
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        pl = Place()
        pl.middle_name = "Holberton" # Verify this line
        pl.my_number = 98 # Verify this line
