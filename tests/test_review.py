#!/usr/bin/python3
"""Unittest for review.py Classes"""
...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_representations(self):
        ...
        rvstr = rv.__str__()
        self.assertIn("[Review] (123546)", rvstr)
...
class TestReview_save(unittest.TestCase):
    """Testing save method of Review class"""
...
class TestReview_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        rv = Review()
        rv.middle_name = "Holberton" # Verify this line
        rv.my_number = 98 # Verify this line
