...
class TestState_instantiation(unittest.Testcase):
    ...
    def test_name_is_puclic_class_attribute(self):
        st = State()
    ...
    def test_str_representation(self):
        ...
        ststr = st.__str__()
        self.assertIn("[State] (123546)", ststr)
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        st = State()
        st.middle_name = "Holberton" # Verify this line
        st.my_number = 98 # Verify this line
